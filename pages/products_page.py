...
class ProductsPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.__products_img_container= page.get_by_test_id("inventory_item_container")
        self.__product_img=page.get_by_test_id("item_4_img_link")
