...
class CheckoutPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.__finish_btn=page.get_by_test_id("finish")
        self.__cancel_btn=page.locator("[data-test=\"cancel\"]")
        self.__back_home_btn= page.get_by_test_id("back-to-products")
...
#Click on Cancel button and verify user is navigated to cart page
    def cancel_checkout_flow_and_verify_navigation(self):
